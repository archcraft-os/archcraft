...
sed -i -e 's/font-0 = .*/font-0 = "scientifica:size=8;2"/g' $polybar_path/forest/config.ini
...
sed -i -e 's/font:.*/font:				 	"scientifica 8";/g' "$rofi_path/forest/font.rasi"
...
sed -i -e 's/font:.*/font:				 	"scientifica 8";/g' "$rofi_path/dialogs/askpass.rasi" "$rofi_path/dialogs/confirm.rasi"
...
# termite ---------------------------------
sed -i -e 's/font = .*/font = scientifica 8/g' $termite_path/config
...
sed -i -e 's/editor_font=.*/editor_font=scientifica 8/g' "$geany_path"/geany.conf
...
xfconf-query -c xsettings -p /Gtk/FontName -s "scientifica 8"
...
sed -i -e 's/font = .*/font = scientifica 8/g' $dunst_path/dunstrc
